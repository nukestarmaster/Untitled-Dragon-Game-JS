const tooltipText = {
    ...
    descText: {
        ...
        building_buildRockpile: "Increases maximum held resources by 10% for each built.",
        ...
        building_buildStorage: "10% more maximum held resources and 5% more resource efficiency per level.",
        building_buildHoard: "Increases all attributes by 1 and 100% more held gold for each built.",
        building_buildLibrary: "10% more skill experience and 100% more held books per level.",
        building_buildPylon: "5% more spell power, efficiency and resilience, and 0.01 passive mana regen per level.",
