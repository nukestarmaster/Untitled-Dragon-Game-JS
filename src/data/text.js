const tooltipText = {
    flavourText: {
        ...
        building_library: "Much like a hoard, but for books. A book-hoard.",
    ...
    descText: {
        ...
        building_library: "Earn 10% more experience (additive with self multiplicative with other mods) and double maximum books per level.",
